...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        filepath = "xx_Test_cut_2.json"
    else:
        print("No input file specified, using example file xx_Test_cut_2")
        filepath = os.path.abspath(os.path.join(__file__, "..", "xx_Test_cut_2.json"))
